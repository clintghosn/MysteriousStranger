...
function callOut() {
    ...
    if (document.getElementById('selected-q').innerHTML.includes('Yes/No')) {
        ...
        scn='';
        document.getElementById('event').innerHTML = `Here are some details.. </br>
...
function describe(){
            ...
            if (adv_desc && Object.keys(adv_desc).length > 0) {
                ...
                document.getElementById('answer').innerText ='Here are some details..';
                someDetailsVoice();            
            }
            else {
                document.getElementById('answer').innerText ="I can't tell you anything right now.. **select at least 1 descriptor**";
                nothingVoice();
            }
}